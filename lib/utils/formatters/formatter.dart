...
class GFormatter {
  ...
  static String formatUSCurrency(double amount) {
    return NumberFormat.currency(locale: 'en_US', symbol: '\$')
        .format(amount); // Customize the currency locale and symbol as needed
  }

  String formatRDCurrency(double amount) {
  ...
  String formatRDPhoneNumber(String phoneNumber) {
    ...
    // Puedes agregar más lógica de formato de número de teléfono personalizada si es necesario.
    return phoneNumber;
  }
